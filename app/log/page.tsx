...
const feelingOptions = ["", "Great", "Decent", "Meh", "Rotten"];
...
type MonthData = Record<string, DayEntry>;

const emptyEntry: DayEntry = { weight: "", steps: "", gym: false, feeling: "", food: "" };

const STORAGE_KEY = "kc-daily-log";
...
function readStoredData(): Record<string, MonthData> {
